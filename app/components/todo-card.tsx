...
export function TodoCard({ todo, onDelete }: TodoCardProps) {
  ...
  return (
    <div
      ...
      className="bg-white border-3 border-black rounded-lg p-4 shadow-[4px_4px_0px_0px_#1a1a1a] cursor-grab active:cursor-grabbing hover:-translate-y-0.5 hover:shadow-[4px_6px_0px_0px_#1a1a1a] transition-all"
    >
